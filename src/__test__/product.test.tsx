...
import ProductList from '../../pages/[...url_key]';
...
describe('ProductList page layout', () => {
  it('should render without errors', async () => {
    await act(() => {
      render(<ProductList />, { mocks, router, testState: true });
    });
    // about-us
    expect(await screen.getByTestId('ProductList')).toBeInTheDocument();
  });
});
